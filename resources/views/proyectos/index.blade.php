 ...
 <!-- MENSAJE ALERTA EXITOSA -->
     ...
     <div class="container-fluid">
        <div class="block mb-8">
            <a href="{{ route('proyectos.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i>&nbsp; Añadir</a>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr class="table-secondary  roboto-medium">
                            ...
                            <td class="text-center">
                              <form action="{{ route("proyectos.show", $dato->id) }}" method="get">
                                <button class="btn btn-warning btn-sm"><i class="bi bi-file-text-fill"></i></button>
                              </form>
                            </td>
                            <td class="text-center">
                              <form action="{{ route("proyectos.edit", $dato->id) }}" method="get">
