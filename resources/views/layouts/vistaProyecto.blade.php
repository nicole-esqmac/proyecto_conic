                    ...
                    <nav class="navbar navbar-expand-lg">
                        <section class="nav-lateral">
                            <div class="nav-lateral-content" class="collapse navbar-collapse" id="navbarScroll">
                               ...
                               <section>
                                    <ul class="list-group">
                                        <a href="{{ route("proyectos.index") }}" class="style-icono"><i class="bi bi-journals style-icono2"></i><h6 class="style-texto">Nombre Proyecto</h6></a>
                                        ...
                                        <a href="{{ route("proyectos.fasesProyectos") }}" class="style-icono"><i class="bi bi-list-ol style-icono2"></i><h6 class="style-texto">Fases</h6></a>
