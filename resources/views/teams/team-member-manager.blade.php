    ...
    @if (Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                <x-slot name="title">
                    {{ __('Añadir miembro del equipo') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Añade un nuevo miembro a tu equipo para que pueda colaborar contigo.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Indique la dirección de correo electrónico de la persona que desea añadir a este equipo.') }}
                        </div>
                    </div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                ...
                <x-slot name="description">
                    {{ __('Estas personas han sido invitadas a su equipo y se les ha enviado una invitación por correo electrónico. Pueden unirse al equipo aceptando la invitación por correo electrónico.') }}
                </x-slot>
