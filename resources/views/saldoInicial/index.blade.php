...
<!-- CONTENT -->
 ...
 <!-- MENSAJE ALERTA EXITOSA -->
  ...
  {{-- TABLA PARA VISUALIZAR SALDO INICIAL --}}
  <div class="container-fluid">
    <div class="block mb-8">
        <a href="{{ route('saldoInicial.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i>&nbsp; Añadir</a>
    </div>
    <br>
    <div class="card">
        <div class="card-body">
          ...
          <table id="tablaSaldoInicial"  class="table table-dark" style="width:100%" >
            ...
            <tbody>
                ...
                <tr class="table-secondary  roboto-medium">
                    ...
                    <td>{{ $dato->saldoInicialEntidad->nombre_entidad}} </td>
                    <td>{{ $dato->descripcion}}</td>
                    <td>Q {{ $dato->total}}</td>
                    <td><span class="badge rounded-pill text-bg-info">{{ $dato->estado}}</span></td>
                    <td>
                        <form action="{{ route("saldoInicial.show", $dato->id) }}" method="get">
                    ...
                    <td>
                        <form action="{{ route("saldoInicial.destroy", $dato->id) }}" method="POST" onsubmit="return confirm('¿Desea cancelar la fila seleccionada ?');">
