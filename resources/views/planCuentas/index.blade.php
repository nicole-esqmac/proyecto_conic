...
<!-- CONTENT -->
      ...
      <div class="container">
          <section class="py-5">
            <h1 class="font-weight-bold mb-0" align="center">LISTA DE DETALLE PLAN DE CUENTAS Y AUXILIARES</h1>
 ...
 <!-- MENSAJE ALERTA EXITOSA -->
  ...
  {{-- TABLA PARA VISUALIZAR NOMECLATURA AGREGADA --}}
            ...
            <legend><i class="bi bi-table"></i> &nbsp; Tabla de detalle nomenclatura plan de cuentas y auxiliares</legend>
            <br>
        <div class="card">
            <div class="card-body">
            <div class="table-responsive">
                ...
                <section>
                    <table id="tablePlanCuenta"  class="table table-dark" style="width:100%">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr class="table-secondary  roboto-medium">
                                ...
                                <td>{{ $dato->claseCuenta->codigo_cuenta }} {{ $dato->claseCuenta->nombre_cuenta }}</td>
                                <td>{{ $dato->grupoCuenta->codigo_cuenta }} {{ $dato->grupoCuenta->nombre_cuenta }}</td>
                                <td>{{ $dato->estadoFinanciero->estadoFinanciero }}</td>
                                <td>{{ $dato->codigo_pc }} {{ $dato->cuenta_pc }}</td>
                                <td>
                                    <form action="{{ route("planCuentas.show", $dato->id) }}" method="get">
                                      <button class="btn btn-warning btn-sm"><i class="bi bi-file-text-fill"></i></button>
                                    </form>
                                </td>
                                <td>
                                    <form action="{{ route("planCuentas.edit", $dato->id) }}" method="get">
...
<script>
$(function(){
    $("#tablePlanCuenta").DataTable(dataTableOpciones);
